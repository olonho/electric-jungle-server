...
%>
      <td width=10 height=10 nowrap bgcolor="<%=tf.bgColor[i]%>" background="images/tab<%=tf.bgImage[i]%>_ul.gif"></td>
      <td height=10 bgcolor="<%=tf.bgColor[i]%>" background="images/tab<%=tf.bgImage[i]%>_uc.gif"></td>
      <td width=10 height=10 nowrap bgcolor="<%=tf.bgColor[i]%>" background="images/tab<%=tf.bgImage[i]%>_ur.gif"></td>
<%   } %>
    </tr>
    <tr>
...
<%
     for (int i = 0; i < tf.count; i++) {
       if (i != 0) out.write("<td width=10 nowrap></td>");
%>
      <td width=10 height=10 nowrap bgcolor="<%=tf.bgColor[i]%>" background="images/tab<%=tf.bgImage[i]%>_dl.gif"></td>
      <td height=10 bgcolor="<%=tf.bgColor[i]%>"></td>
      <td width=10 height=10 nowrap bgcolor="<%=tf.bgColor[i]%>" background="images/tab<%=tf.bgImage[i]%>_dr.gif"></td>
<%   } %>
    </tr>
    <tr><td colspan=<%=tf.count * 4 - 1%> height=5></td></tr>
  </table>
